...
function Contact() {
  return (
    <>
      ...
      <body>
        <section className="container flex flex-col laptop:flex-row items-center justify-center gap-2 px-2 sm:px-6 md:px-8 xl:px-16 py-8 lg:px-50 lg:py-10 min-h-screen">
